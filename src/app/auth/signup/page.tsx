          ...
          <div className="px-8 pb-8">
            ...
            {error && (
              <div className={`mb-6 p-4 border rounded-lg ${
                error.includes('이메일/비밀번호 회원가입이 현재 비활성화') 
                ...
                {error.includes('이메일/비밀번호 회원가입이 현재 비활성화') && (
                  <div className="mt-3">
                    <button
                      ...
                      className="w-full flex items-center justify-center px-4 py-3 border border-blue-300 rounded-lg bg-white hover:bg-blue-50 transition-colors duration-200 shadow-sm"
                    >
